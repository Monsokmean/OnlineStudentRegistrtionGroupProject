                            ...
                            <div class="card-body"  style="box-shadow: rgb(38, 57, 77) 0px 20px 30px -10px;">
                                <form name="pincodeverify" method="post">
                                    <div class="form-group">
                                        <label for="pincode" class="mt-3 font-monospace fw-bold card-title">Enter Pincode</label>
                                        <input type="password" class="form-control" id="pincode" name="pincode"
                                               placeholder="Pincode" required/>
                                    </div>

                                    <button type="submit" name="submit" class="btn btn-danger mt-3" style="border-radius: 15px">Verify</button>
                                    <hr/>
