    ...
    <div class="content-wrapper">
        <div class="container">
                            ...
                            <div class="card-body">
                                <form name="semester" method="post">
                                    <div class="form-group">
                                        <label for="semester" class="mt-3 font-monospace fw-bold card-title">Add
                                            Semester </label>
                                        <input type="text" class="form-control mt-3" id="semester" name="semester"
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading badge bg-warning text-wrap text-uppercase fs-5 font-monospace d-flex justify-content-center mt-5">
                        Manage Semester
                    </div>
