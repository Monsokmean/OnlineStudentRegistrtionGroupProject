            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="panel panel-default">
                        <div class="panel-heading badge bg-danger text-wrap text-uppercase fs-5 font-monospace d-flex justify-content-center">
                            Edit Course
                        </div>
                        <font color="green"
                                ...
                                <form name="dept" method="post">
                                    ...
                                    while ($row = mysqli_fetch_array($sql)) {
                                        ...
                                        <div class="form-group">
                                            <label for="coursecode" class="mt-3 font-monospace fw-bold card-title">Course Code </label>
                                        ...
                                        <div class="form-group">
                                            <label for="coursename" class="mt-3 font-monospace fw-bold card-title">Course Name </label>
                                        ...
                                        <div class="form-group">
                                            <label for="courseunit" class="mt-3 font-monospace fw-bold card-title">Course unit </label>
                                        ...
                                        <div class="form-group">
                                            <label for="seatlimit" class="mt-3 font-monospace fw-bold card-title">Seat limit </label>
                                    ...
                                    <?php } ?>
                                    <button type="submit" name="submit" class="btn btn-danger mt-3" style="border-radius: 15px"><i
