                        ...
                        <div class="card">
                            <div class="card-body">
                                <form name="dept" method="post">
                                    ...
                                    <div class="form-group">
                                        <label for="coursename" class="mt-2 form-label fw-bold">Course Name </label>
                                        <input type="text" class="form-control" id="coursename" name="coursename"
                                               placeholder="Course Name" required/>
                                    </div>

                                    <div class="form-group">
                                        <label for="courseunit" class="mt-2  form-label fw-bold">Course unit </label>
                                        <input type="text" class="form-control" id="courseunit" name="courseunit"
                                               placeholder="Course Unit" required/>
                                    </div>

                                    <div class="form-group">
                                        <label for="seatlimit" class="mt-2  form-label fw-bold">Seat limit </label>
                                        <input type="text" class="form-control" id="seatlimit" name="seatlimit"
                                               placeholder="Seat limit" required/>
                                    </div>

                                    <button type="submit" name="submit" class="btn btn-primary mb-3 mt-3">👉Create</button>
                                </form>
                            </div>
                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="edit-course.php?id=<?php echo $row['id'] ?>">
                                                <button class="btn btn-primary mb-3"><i class="fa fa-edit "></i> Edit
                                                </button>
                                            </a>
